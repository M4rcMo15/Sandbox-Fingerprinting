...
# Hosts permitidos
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '54.37.226.179,localhost,127.0.0.1').split(',')

# CSRF
CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'http://54.37.226.179').split(',')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/var/log/artefacto-visualizer/django.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
